class UserData:
    ...
    USER_DATA_0 = ['Иван', 'Петров', 'Кировоградская улица, 15', 'Домодедовская', '+79057776566', '27.10.2024', 'Ура, идём кататься!']

    USER_DATA_1 = ['Петр', 'Иванов', 'Севастопольский проспект,3', 'Белорусская', '+79264448899', '30.09.2024', 'Отличная погода, пора совершить новое путешествие:)']

    data_expected_answer = [
